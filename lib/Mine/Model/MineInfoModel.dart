...
class MineInfoModel {
  ...
  BuildContext ctx;
  String iconTip;
  MineInfoModel(this.cellType, this.title, this.subTitle, this.titleColor,
      this.iconTip, this.onTap,
...
Future<List> fetchModels() async {
  ...
  models.add(MineInfoModel(MineInfoCellType.Accessory, '手机号', info.mobile, null,
  ...
  models.add(MineInfoModel(MineInfoCellType.Accessory, '擦肩号', info.cajianNo,
      null, null, (MineInfoModel model) {}));
  models.add(MineInfoModel(
      MineInfoCellType.HeaderImg,
      '我的二维码',
      null,
      null,
      ...
      (MineInfoModel model) =>
          FlutterBoost.singleton.open('qrcode', urlParams: {
            'title': '我的二维码',
            'content': 'https://api.youxi2018.cn/v2/jump/p/' + info.userId,
            'embeddedImgAssetPath': info.avatarUrlString == null
