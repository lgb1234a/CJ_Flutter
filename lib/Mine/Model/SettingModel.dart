...
class SettingModel {
  ...
  SettingModel(
      this.cellType, this.title, this.subTitle, this.titleColor, this.onTap,
...
final List<SettingModel> settingCellModels = [
  ...
  SettingModel(SettingCellType.Separator, null, null, null, null,
      needSeparatorLine: false),
  SettingModel(
      SettingCellType.Accessory, '新消息通知', null, null, (SettingModel model) {}),
  SettingModel(
      SettingCellType.Accessory, '黑名单', null, null, (SettingModel model) {}),
  SettingModel(
      SettingCellType.Accessory, '清理缓存', null, null, (SettingModel model) {},
      needSeparatorLine: false),
  SettingModel(SettingCellType.Separator, null, null, null, null,
      needSeparatorLine: false),
  SettingModel(
      SettingCellType.Accessory, '关于', null, null, (SettingModel model) {},
      needSeparatorLine: false),
  SettingModel(SettingCellType.Separator, null, null, null, null,
      needSeparatorLine: false),
