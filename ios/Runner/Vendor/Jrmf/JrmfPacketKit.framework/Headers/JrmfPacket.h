...
/**
 ...
 @param model 红包信息，详细查看 JRMFPacketModel
 @param status 发送状态
 */
- (void)dojrmfActionSendRedPacketWith:(JRMFPacketModel *)model withStatus:(jrmfSendStatus)status;
 ...
 *  @param type     红包类型
 */
- (void)dojrmfActionDidSendEnvelopedWithID:(NSString *)envId Name:(NSString *)envName Message:(NSString *)envMsg Stat:(jrmfSendStatus)jrmfStat packType:(JrmfRedPacketType)type __deprecated_msg("Use dojrmfActionSendRedPacketWith:withStatus:");
 ...
 *  @param jrmfStat 发送状态
 */
- (void)dojrmfActionDidSendEnvelopedWithID:(NSString *)envId Name:(NSString *)envName Message:(NSString *)envMsg Stat:(jrmfSendStatus)jrmfStat __deprecated_msg("Use dojrmfActionSendRedPacketWith:withStatus:");
...
@property (nonatomic, weak) id <jrmfManagerDelegate> delegate;
@property (nonatomic, weak) id <jrmfManagerTrfDelegate> trfDelegate;
...
/**
 ...
 在AppDelegate 实现
 - (BOOL)application:(UIApplication *)application openURL:(NSURL *)url sourceApplication:(NSString *)sourceApplication annotation:(id)annotation 方法传递对应参数
...
/**
 ...
 在 AppDelegate 实现
 - (BOOL)application:(UIApplication *)app openURL:(NSURL *)url options:(NSDictionary<NSString*, id> *)options 方法传递对应参数
