...
UIKIT_EXTERN NSString * const kMFWalletShow;/**< 界面出现 */
UIKIT_EXTERN NSString * const kMFWalletHide;/**< 界面消失 */

@interface MFWallet : NSObject
 ...
 */
+ (void)instanceMFWalletSDKWithPartnerId:(NSString *)partnerId AppMethod:(BOOL)isOnline;
...
/**
 ...
 @param isOnline  测试环境  默认NO：测试环境
 */
+ (void)instanceMFWalletSDKWithPartnerId:(NSString *)partnerId dynamicToken:(BOOL)dynamicToken AppMethod:(BOOL)isOnline;

+ (void)instanceMFWalletSDKWithPartnerId:(NSString *)partnerId dynamicToken:(BOOL)dynamicToken customerClass:(NSString *)className AppMethod:(BOOL)isOnline;
