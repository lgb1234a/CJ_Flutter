 ...
 */
class UnreadAckMsgFragment : TFragment(), TAdapterDelegate {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        initAdapter()
        findViews()
        val message = activity!!.intent.getSerializableExtra(AckMsgInfoActivity.EXTRA_MESSAGE) as IMMessage
        ...
        viewModel?.teamMsgAckInfo?.observe(this, Observer<TeamMsgAckInfo?> {
            teamMsgAckInfo ->
            for (account in teamMsgAckInfo!!.unAckAccountList) {
    ...
    private fun initAdapter() {
        ...
        adapter = AckMsgDetailAdapter(activity, dataSource, this)
    }
