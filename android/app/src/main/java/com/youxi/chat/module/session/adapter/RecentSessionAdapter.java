...
public class RecentSessionAdapter extends BaseMultiItemQuickAdapter<RecentContact, BaseViewHolder> {
    ...
    public RecentSessionAdapter(RecyclerView recyclerView, List<RecentContact> data) {
        ...
        addItemType(ViewType.VIEW_TYPE_COMMON, R.layout.session_list_item, CommonRecentViewHolder.class);
        addItemType(ViewType.VIEW_TYPE_TEAM, R.layout.session_list_item, TeamRecentViewHolder.class);
    }
